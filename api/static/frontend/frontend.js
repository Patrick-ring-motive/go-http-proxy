...
function $() {
  var u;
  let t = document.querySelector(".JumpDialog"),
    e = t == null ? void 0 : t.querySelector(".JumpDialog-body"),
    o = t == null ? void 0 : t.querySelector(".JumpDialog-list"),
    i = t == null ? void 0 : t.querySelector(".JumpDialog-input"),
    l = document.querySelector(".js-documentation"),
    m;
          ...
          if (!m && Array.isArray(n) && n.length > 0) {
            for (let d of n)
              if (d.isIntersecting && d.target instanceof HTMLElement) {
                let {
                  id: h
                } = d.target, E = document.querySelector('[href="#' + h + '"]');
